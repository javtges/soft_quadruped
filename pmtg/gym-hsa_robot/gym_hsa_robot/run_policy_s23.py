...
if __name__ == "__main__": 
    ...
    # NEW POLICY!!!!
    # /home/tommy/tommy-dev/soft_quadruped/epoch_106_0.3988122556425218.npy
    #policy.theta = np.load('/home/tommy/tommy-dev/soft_quadruped/epoch_106_0.3988122556425218.npy')
    ...
    while True:
        ...
        if len(tags) != 0:
            ...
            eps_fl, theta_fl, x_fl, y_fl = tg_arr[0].step_traj(width=0.015*(1+action[0]), height=0.003*(1+action[1]), res_x=0.023*(action[2]), res_y=0.005*(action[3]), step_theta=24, step_time = abs(action[10]))
            eps_fr, theta_fr, x_fr, y_fr = tg_arr[1].step_traj(width=0.015*(1+action[0]), height=0.003*(1+action[1]), res_x=0.023*(action[4]), res_y=0.005*(action[5]), step_theta=24, step_time = abs(action[10]))
            eps_rl, theta_rl, x_rl, y_rl = tg_arr[2].step_traj(width=0.015*(1+action[0]), height=0.003*(1+action[1]), res_x=0.023*(action[6]), res_y=0.005*(action[7]), step_theta=24, step_time = abs(action[10]))
            eps_rr, theta_rr, x_rr, y_rr = tg_arr[3].step_traj(width=0.015*(1+action[0]), height=0.003*(1+action[1]), res_x=0.023*(action[8]), res_y=0.005*(action[9]), step_theta=24, step_time = abs(action[10]))
