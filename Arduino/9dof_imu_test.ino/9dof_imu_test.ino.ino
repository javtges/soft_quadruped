...
#define DECLINATION -4.01 // Declination (degrees) in Boulder, CO.
...
void loop()
{
  ...
  {
//      printData();  // Print "G: gx, gy, gz"
//    printAccel(); // Print "A: ax, ay, az"
//    printMag();   // Print "M: mx, my, mz"
    
    printData(imu.ax, imu.ay, imu.az,
...
void printData(float ax, float ay, float az, float mx, float my, float mz)
{
